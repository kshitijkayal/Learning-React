      ...
      {item.map((singleItem, index) => (
        ...
        >
          ...
          <div className="ml-4 relative">
            ...
            />
            <button className="absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-1/2 bg-orange-500 hover:bg-orange-600 text-white font-semibold px-5 py-2 rounded-lg shadow-lg hover:shadow-xl transition-all duration-200 text-sm border-2 border-white whitespace-nowrap cursor-pointer">
              Add +
            </button>
          </div>
        </div>
